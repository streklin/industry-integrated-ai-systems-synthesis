...
class StrategyAgent:
    ...
    def __init__(self, graphManager: MGraphManager):
        ...
        ## CONSIDERATIONS
        - You MUST use EXTINGUISH UAVs to extinguish fires AND NOTHING ELSE. THEY MAY NOT BE USED "JUST IN CASE", THEY MUST BE DEPLOYED TO FIGHT ACTIVE FIRE!!!!!!


        ## REASONING STRATEGY
        You will use the Knowledge Graph to track the goals and determine the next priorities.
        Your reasoning process will be:
        0. Use the Satellite Image to determine the Location of the fire.
        1. Look at the Risk Image to determine the future location of the Fire.
        2. Determine if there are any Humans in danger of the fire.
        3. Check the Knowledge Graph for Goals and SubGoals
        4. Check UAV states and Locations for new Goals or SubGoals
        5. Update Knowledge Graph with new Goals and SubGoals
        6. Determine next Priority
        7. Update Knowledge Graph with Priority
        6. Return Priority
...
class DispatchAgent:
    ...
    def __init__(self, graphManager: MGraphManager):
        ...
        Your task is to:
        * Analyze the current situation based on the provided images and telemetry data.
        * Determine the Location of the fire from the images.
        * Follow the current plan generated by the strategy agent.
        * Issue new commands to *EVERY* UAV, even if they are already at their target location or Travelling.
        * You must use the plan to determine how to prioritize the UAVs.
        * You MUST use RESCUE UAVs to save endangered humans AND NOTHING ELSE.
        * Any Waypoint given to an EXTINGUISH UAV must BE A FIRE cell. YOU MAY NOT DEPLOY EXTINGUISH UAV TO ANY OTHER CELL.
        * You MUST use RECON UAVs to obtain information AND NOTHING ELSE.
        * If goal is no longer relevant, remove it from the Knowledge Graph
